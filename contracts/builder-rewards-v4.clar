;; title: Builder Rewards Contract V4 (Emergency Withdraw)
;; version: 4.0.0
;; summary: A Clarity contract for Stacks Builder Challenge with 0.1 STX fees and rewards
;; description: Enhanced version with 0.1 STX check-in fee, 0.1 STX rewards, and emergency withdrawal.
...
;; Owner function to withdraw ENTIRE balance
(define-public (withdraw-all-funds)
  (let
    ...
    (print {event: "withdraw-all", amount: amount, recipient: contract-owner})
    (ok amount)
  )
)
